...
{
    dir[0] = (float)(MikuPan_Rand() - (int)(RAND_MAX / 2)) / (float)RAND_MAX;
    dir[1] = (float)(MikuPan_Rand() - (int)(RAND_MAX / 2)) / (float)RAND_MAX;
    dir[2] = (float)(MikuPan_Rand() - (int)(RAND_MAX / 2)) / (float)RAND_MAX;
    dir[3] = 0.0f;
